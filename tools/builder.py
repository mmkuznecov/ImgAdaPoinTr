...
def dataset_builder(args, config):
    ...
    if args.distributed:
        ...
        dataloader = torch.utils.data.DataLoader(dataset, batch_size =64,# config.others.bs if shuffle else 1,
...
def resume_optimizer(optimizer, args, logger = None):
    ...
    # optimizer
#     print("len(state_dict['optimizer']['param_groups'])", len(state_dict['optimizer']['param_groups']))
#     state_dict['optimizer']['param_groups'][-1]['lr'] = 0.0001
#     state_dict['optimizer']['param_groups'][0]['lr'] = 0.0001
