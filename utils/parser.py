...
def get_args():
    ...
    #MY ARGS
    parser.add_argument('--output-dir', type = str, default='inference_result', help = 'experiment name')
    # some args
    parser.add_argument('--exp_name', type = str, default='example3', help = 'experiment name')
    parser.add_argument('--start_ckpts', type = str, default=None, help = 'reload used ckpt path')
    parser.add_argument('--ckpts', type = str, default='./pretrained/AdaPoinTr_PCN.pth', help = 'test used ckpt path')
    ...
    parser.add_argument(
        ...
        action='store_true', 
        default=False, 
        help = 'use pretrained modality transfer')
    parser.add_argument(
        '--test', 
        action='store_true', 
        default=False, 
