...
def seprate_point_cloud(xyz, num_points, crop, fixed_points = None, padding_zeros = False):
    ...
    CROP = []
    for points in xyz:
#         print('points', points.shape)  #torch.Size([8192, 3])
...
#             print('fixed_points', fixed_points)  #example tensor([ 1., -1., -1.])
#             print('fixed_point', fixed_point)    #example tensor([ 1., -1., -1.])
#             print('center', center)              #example tensor([ 1., -1., -1.])
#         print('center.unsqueeze(2)', center.unsqueeze(2), center.unsqueeze(2).shape) # torch.Size([1, 1, 1, 3])
#         print('points.unsqueeze(1)', points.unsqueeze(1).shape, points.unsqueeze(1))  # torch.Size([1, 1, 8192, 3])

        distance_matrix = torch.norm(center.unsqueeze(2) - points.unsqueeze(1), p =2 ,dim = -1)  # 1 1 2048
#         print('distance_matrix', distance_matrix.shape)  #torch.Size([1, 1, 8192])
